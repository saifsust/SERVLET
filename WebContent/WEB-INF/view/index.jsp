...
/FUNNY_WEB_APP/WebContent/resources/css/tooplate_style.css
...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/nivo-slider.css" type="text/css" media="screen" />
<script src="${pageContext.request.contextPath }/resources/js/jquery.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath }/resources/js/jquery.nivo.slider.js" type="text/javascript"></script>
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
    	...
    	<div class="col_allw300">
            ...
            <p><em>Phasellus eros ante, mollis eget sodales eu, vulputate nisl. Validate <a href="http://validator.w3.org/check?uri=referer" rel="nofollow"><strong>XHTML</strong></a> and <a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow"><strong>CSS</strong></a>.</em><br />
               Iron Rush is a <a rel="nofollow" href="http://www.tooplate.com/free-templates">free website template</a> for everyone. Credit goes to <a rel="nofollow" href="http://www.photovaco.com">Free Photos</a> for Photos. You may download, edit, and use this template for any kind of website.</p>
